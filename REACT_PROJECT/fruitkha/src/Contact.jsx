...
function Contact() {
  return (
    <div>
		...
		{/* contact form */}
		<div className="contact-from-section mt-150 contect-mb text-start">
			<div className="container">
				<div className="row">
					<div className="col-lg-8 mb-5 mb-lg-0">
						<div className="form-title">
							<h2 className='fw-bold'>Have you any question?</h2>
						...
						<div className="contact-form">
							<form  id="fruitkha-contact">
								<p>
								<input type="text" placeholder="Name" name="name" id="name" className='me-2' />
								<input type="email" placeholder="Email" name="email" id="email" />
								</p>
								<p>
								<input type="tel" placeholder="Phone" name="phone" id="phone" className='me-2'/>
